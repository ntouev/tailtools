...
% fprintf('Accel z: '); fprintf('%.3f ', mdl_tranz.Coefficients.Estimate(1));
% fprintf(', Accel z (x 10^-8): '); fprintf('%.2f ', mdl_tranz.Coefficients.Estimate(2:end)*1e8); fprintf('\n');
% 
% fprintf('Ang x   (x 10^-8): '); fprintf('%.1f ', mdl_angx.Coefficients.Estimate*1e8); fprintf('\n');
% fprintf('Ang y: '); fprintf('%.3f ', mdl_angy.Coefficients.Estimate(1));
% fprintf(', Ang y   (x 10^-8): '); fprintf('%.0f ', mdl_angy.Coefficients.Estimate(2:end)*1e8); fprintf('\n');
